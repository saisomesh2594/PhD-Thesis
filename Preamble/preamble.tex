...
\titleformat{\section}[display]{\Large\bfseries}{\color{black}\thesection}{6pt}
{\begin{tabular}[t]{@{}>{}l}#1\end{tabular}\vspace{3pt}\hrule}
...
%\addbibresource{References/Trial} %Location of references.bib only for biblatex, Do not omit the .bib extension from the filename.
