...
% Supervisor details
\include{SupervisorPage/supervisorpage}
...
\include{Chapter8/chapter8} % Aims
\include{Chapter4/chapter4} % Diet-Aging
\include{Chapter5/chapter5} % Meta-analysis
\include{Chapter6/chapter6} % Discussion
\include{Chapter7/chapter7} % Methods
...
% change geometry to single page for the next sections
...
% *************************************
 ...
 % Using appendices environment for more functionality
\begin{appendices}
