...
\begin{table}[ht!]
  ...
  \begin{tabularx}{\textwidth}{xCC}
    ...
    \midrule
    158Gd & CRTH2 (\textit{Ptgdr2}) & \RaggedRight{\gls{th2} cells} \\
    \midrule
  %\rowcolor{rowgray}
    ...
    \cline{1-2}
    191Ir & \hspace{2em}\multirow{2}{*}{\glsentryshort{dna} Intercalator} & \\
    \cline{1-1}
    193Ir &  & \\
    \bottomrule
  \end{tabularx}
  ...
  \textbf{\glsentryshort{pdc}}, \glsentrylong{pdc}; \textbf{\glsentryshort{nk}}, \glsentrylong{nk};
  \textbf{\glsentryshort{th2}}, \glsentrylong{th2};
  \textbf{\glsentryshort{treg}}, \glsentrylong{treg}; \textbf{\glsentryshort{tf}}, \glsentrylong{tf}.
\end{table}
...
\begin{table}[ht!]
  ...
  \centering
 \caption[\glsentryshort{qc} and preprocessing summary of the \glsentryshort{scr} data]{\gls{qc} and preprocessing summary of the \gls{scr} data.}
  ...
  \begin{tabularx}{\textwidth}{x C C C C C C}
    ...
    \midrule
     W1-Chow-1 & \multirow{5}{*}{\makecell{10 weeks}} & \multirow{5}{*}{\makecell{1 week}} &  \multirow{3}{*}{\makecell{Chow}} & 3087 & 2987 & 13402 \\
     \cline{1-1} \cline{5-7}
    ...
    \midrule
    W12-Chow-1 & \multirow{5}{*}{\makecell{21 weeks}} & \multirow{5}{*}{\makecell{12 weeks}} &  \multirow{3}{*}{\makecell{Chow}} & 2989 & 2574 & 10448 \\
     \cline{1-1} \cline{5-7}
    ...
    \midrule
    Aging-1 & \multirow{2}{*}{\makecell{\textasciitilde2 years}} & \multirow{2}{*}{\makecell{95 weeks}} &  \multirow{2}{*}{\makecell{Chow}} & 26170 & 1728 & 5478 \\
     \cline{1-1} \cline{5-7}
...
\renewcommand{\arraystretch}{1.2}
  ...
  \begin{tabularx}{\textwidth}{W{2.5cm}  C  C  C}
   ...
   \end{tabularx}
   \vspace{0.1cm}
   \RaggedRight{\footnotesize \\ \textsuperscript{*}After initial preprocessing and quality control\\ \textsuperscript{**}After additional quality control\\ $\dagger$ The number of non-proliferating β-cells are denoted in parentheses.\\\textbf{WD}, western Diet; \textbf{STZ}, streptozotocin; \textbf{wks}, weeks}
\end{table}
